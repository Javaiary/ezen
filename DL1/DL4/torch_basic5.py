...
'''
    tr.Compose() : 여러 개의 이미지 전처리 기능을 연결해서 사용할 수 있게 해주는 함수
...
'''
    * Model Class 만들기
        1) nn.Module을 상속하여 정의 (neural network)
            - nn.Module을 상속받는 모델은 기본적으로 __init()__과 forwar()함수를 포함
            - __init()__
                - 활성화 함수
            - forward()
...
# 가상의 data로 예측하기
# 입력데이터 x 생성 - 28*28 크기의 이미지가 1개 들어있는 텐서임
