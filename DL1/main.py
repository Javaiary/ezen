...
EPOCHS = 20 #전체 데이터셋을 몇회 학습시킬 것이냐, 몇 번 반복할 것인지 의미
...
model = keras.Sequential([
    keras.layers.Dense(3),      # 첫 번쨰 층은 3개의 유닛을 가지고 있으며 한 레이어 구성
    keras.layers.Dense(128, activation="relu"),    # 두 번쪠 층은 128개의 유닛을 가지고 한 레이어 구성, 렐루함수
    keras.layers.Dense(3, activation="softmax")    # 세 번째 층은 3개의 유닛을 가지고 있으며 한 레이어 구성
])
