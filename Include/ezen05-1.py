...
'''
    ...
    - Ezen777 모델로 10epoch를 반복학습시킨 결과는 학습 정확도 : 0.85, 검증 정확도: 0.83, 테스트 정확도 : 0.76으로 나왔습니다.
'''
...
# case1
print(f'{model_name} 모델로 {epoch} epoch를 반복 학습시킨 결과는 학습정확도 : {train_accuracy}, 검증 정확도 : {val_accuracy}, 테스트 정확도: {test_accuracy}으로 나왔습니다.')

# case2
print("{} 모델로 {}epoch를 반복학습시킨 결과는 학습 정확도 : {}, 검증 정확도: {}, 테스트 정확도 : {}으로 나왔습니다.".format("Ezen777", 10, 0.85, 0.83, 0.76))

# case3 
print("%s 모델로 %d epoch를 반복학습시킨 결과는 학습 정확도 : %.2f, 검증 정확도: %.2f, 테스트 정확도 : %.2f으로 나왔습니다." %("Ezen777",10, 0.85, 0.83, 0.76))
...
'''
    주민등록번호의 뒷 6자리를 가려주는 코드를 작성하시오.
    921124-1234567 => 921124-1******
'''
ezen_man = "921124-1234567"
ezen_woman = "201210-2345678"
ezen_man2 = "891209-3456789"
ezen_woman2 = "041210-4567890"
...
# ezen의 index 2 부터 끝까지 잘라내시오.
print(ezen[2:])

# ezen의 원소 중 'a'를 출력해 보시오.
print(ezen[1][0])

# 리스트에서 제공하는 함수들이 무엇이 있는지 확인하시오.
print(type(ezen))
print(dir(ezen))