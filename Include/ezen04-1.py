...
# 리스트 - 가변(mutable), 문자열은 불변(inmutable)
...
# 리스트 덧셈: 리스트끼리 덧셈 가능, 단순히 두 리스트를 이어붙인 결과가 반환됨
a=[1,2,3,4,5]
b=[6,7,8,9,10]
...
# 4 X 5 크기를 갖는 2차원 리스트 초기화 00000 00000 ....
arr = [[0]*5 for x in range(4)]
print(arr)

# 4 X 5 크기를 갖는 2차원 리스트 초기화 00000 11111 22222 ...
arr = [[i] * 5 for i in range(4)]
print(arr)

# 4 X 5 크기를 갖는 2차원 리스트 초기화 01234 56789 ...
